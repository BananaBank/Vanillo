...
public class RecycleRecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> consumer) {
        save(consumer, BuiltInRegistries.ITEM.getKey(this.result.getItem()).toString());
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation id) {
        ...
        consumer.accept(new Result(id, group == null ? "" : group, input, result, xp, duration, advancement, new ResourceLocation(id.getNamespace(), "recipes/" + BuiltInRegistries.ITEM.getKey(this.result.getItem()) + "/" + id.getPath())));
    }
