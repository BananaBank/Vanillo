...
public class VItemModelProvider extends ItemModelProvider {
    public VItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, Vanillo.ID, existingFileHelper);
    }
    ...
    @SafeVarargs
    private <T extends ItemLike> void generic3d(RegistryObject<T>... objects) {
