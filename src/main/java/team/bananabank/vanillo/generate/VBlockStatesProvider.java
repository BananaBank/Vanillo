...
public class VBlockStatesProvider extends BlockStateProvider {
    public VBlockStatesProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, Vanillo.ID, exFileHelper);
    }

    @Override
    protected void registerStatesAndModels() {
        // Creating Blockstates + Models
        ResourceLocation dirtLoc = mcLoc("block/dirt");
        ResourceLocation coarseDirtLoc = mcLoc("block/coarse_dirt");
    ...
    private void curvedRail(RegistryObject<Block> rail) {
        String name = rail.getId().getPath();
