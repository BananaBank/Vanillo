...
public class ColoredGlintAnvilRecipe {
    private static final Object2ByteMap<TagKey<Item>> TAG_COLOR_2_INDEX = Util.make(new Object2ByteLinkedOpenHashMap<>(), map -> {
    ...
    public static void onAnvilUpdate(AnvilUpdateEvent event) {
        ...
        if (left.hasFoil() && (right.is(Tags.Items.DYES) || right.is(Tags.Items.GEMS_DIAMOND))) {
            for (Object2ByteMap.Entry<TagKey<Item>> tag : TAG_COLOR_2_INDEX.object2ByteEntrySet()) {
