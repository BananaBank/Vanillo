...
public class VoidBowItem extends BowItem {
    private static final MobEffectInstance[] IMPULSE_EFFECT = new MobEffectInstance[] {
            new MobEffectInstance(MobEffects.POISON, 100, 1, false, false, false),
            new MobEffectInstance(MobEffects.WITHER, 100, 1, false, false, false),
            new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1, false, false, false),
            new MobEffectInstance(MobEffects.WEAKNESS, 200, 1, false, false, false)
    };
    ...
    public static void cleanupEntities(EntityLeaveLevelEvent event) {
