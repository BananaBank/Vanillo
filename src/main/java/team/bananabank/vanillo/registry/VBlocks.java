...
import team.bananabank.vanillo.block.RecyclerBlock;
import team.bananabank.vanillo.block.VPoweredRailBlock;
import team.bananabank.vanillo.block.VRailBlock;
...
public final class VBlocks {
    ...
    // Void Equipment
    public static final RegistryObject<Block> VOID_ORE = BLOCKS.register("void_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.ANCIENT_DEBRIS).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).lightLevel(blockState -> 13), ConstantInt.of(10)));
