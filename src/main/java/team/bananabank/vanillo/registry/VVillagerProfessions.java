...
public class VVillagerProfessions {
    public static final DeferredRegister<VillagerProfession> PROFESSIONS = DeferredRegister.create(Registries.VILLAGER_PROFESSION, Vanillo.ID);

    public static final RegistryObject<VillagerProfession> CONDUCTOR = PROFESSIONS.register("conductor", () -> new VillagerProfession("conductor", holder -> holder.is(VPoiTypes.CONDUCTOR.getKey()), holder -> holder.is(VPoiTypes.CONDUCTOR.getKey()), ImmutableSet.of(), ImmutableSet.of(), SoundEvents.VILLAGER_WORK_WEAPONSMITH));
